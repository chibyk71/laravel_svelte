...
<TopBar title="create post" class="bg-white">
    <svelte:fragment slot="right">
		<button form="create" type="submit" class="post-btn">POST</button>
    </svelte:fragment>
</TopBar>
<!-- Header End -->
    <div class="page-content">
		<div class="container">
			...
			<div class="post-content-area">
				<form action="/create" method="post" id="create" enctype="multipart/form-data" bind:this={form}>
    ...
    <footer class="footer border-0 fixed bg-transparent">
        <div class="container pt-0">
				<ul class="element-list">
					{#if form}
						<Uploader on:success={()=>form.reset()} {form} multiple={true}>
