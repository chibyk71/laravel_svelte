		...
		<div class="container h-screen">
			<div class="welcome-area">
				...
				<div class="join-area">
					...
					<form action="/login" on:submit|preventDefault={()=>handleSubmit($form,"/login")} method="post" id="login">
						<div class="mb-3 input-group input-group-icon">
							...
							<input type="email" bind:value={$form.email} name="email" class="form-control w-full !pl-12" placeholder="Email">
						</div>
						<div class="mb-3 input-group input-group-icon">
							<span class="input-group-text top-0.5 left-0.5 absolute">
								<div class="input-icon">
							...
							<input type="password" bind:value={$form.password} name="password" class="form-control w-full !pl-12 dz-password" placeholder="Password">
