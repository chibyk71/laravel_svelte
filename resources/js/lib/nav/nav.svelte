<script lang="ts">
    import { GearSolid, SquarePlusRegular, UserRegular } from "svelte-awesome-icons";
    import { ShowHeader, userHasInteracted } from "../util/userStore";
...
<style lang="postcss">
    header {
        @apply transition-transform -translate-y-full duration-500;
        &.active{
            @apply translate-y-0;
        }
    }
</style>
<header class="header bg-black/20 fixed top-0 trans w-full" class:active={$ShowHeader}>
    <div class="container">
        <div class="main-bar">
            <div class="left-content">
                <h4 class="title mb-0 font-bold text-lg/none text-gray-300">Home</h4>
            </div>
