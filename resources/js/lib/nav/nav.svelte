<script lang="ts">
    import { SquarePlusRegular, UserRegular } from "svelte-awesome-icons";
    ...
    <div class="container">
        <div class="main-bar">
            ...
            <div class="right-content flex items-center">
                ...
                {#if user.is_admin}
                    <a href="/create" class="bell-icon menu-toggler mr-2">
                        <SquarePlusRegular />
                    </a>
                {/if}
                <a href="/notification" class="bell-icon mr-2">
                ...
                <a href="/profile" class="bell-icon menu-toggler">
                    <UserRegular />
                </a>
            </div>
        </div>
